  ...
  <script>
    function chart_div_fc1() {
      ...
      function placeMarker(dataTable) {
        ...
        document.querySelector('#chart_div_mp1').style.top = Math.floor(chart_li.getYLocation(dataTable.getValue(0, 0))) - 350 + "px";
        document.querySelector('#chart_div_mp1').style.left = Math.floor(chart_li.getXLocation(dataTable.getValue(0, 0))) - 140 + "px";
      };
